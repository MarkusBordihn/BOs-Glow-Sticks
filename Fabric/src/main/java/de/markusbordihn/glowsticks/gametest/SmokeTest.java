...
public class SmokeTest {
  ...
  @GameTest(template = "glow_sticks:gametest.3x3x3", batch = "glowStickLifetimeVanish")
  public void testGlowStickAgesAndVanishes(GameTestHelper helper) {
    GlowStickTests.testGlowStickAgesAndVanishes(helper);
  }

  @GameTest(template = "glow_sticks:gametest.3x3x3", batch = "glowStickLifetimeZero")
  ...
  @GameTest(template = "glow_sticks:gametest.3x3x3", batch = "glowStickLifetimeDrops")
